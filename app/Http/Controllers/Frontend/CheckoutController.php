    ...
    class CheckoutController extends Controller
{
    ...
    public function store(Request $request){
        ...
        [ 
            'first_name.required' => 'আপনার নামটি লিখুন ।',
            'mobile.required' => 'আপনার মোবাইল নাম্বারটি লিখুন ।',
            'shipping_address.required' => 'আপনার ঠিকানা  লিখুন ।',
            'delivery_charge_id.required' => 'আপনার এরিয়া সিলেক্ট করুন।',
         ]);
