...
class OrderController extends Controller
{
    ...
    public function create()
    {
       ...
       // $areas = $this->getRedxAreaList();
        ...
        return view('backend.orders.create', compact('status','charges','couriers', 'cities'));
    ...
    public function edit($id){
        ...
        // $areas = $this->getRedxAreaList();
      	//$stores = $this->getPathaoStoreList();
      	$cities = $this->getPathaoCityList();
        return view('backend.orders.edit', compact('item','status','charges','couriers', 'cities','orderbyNumber'));
    ...
    public function getOrderProduct(Request $request)
    {
        ...
        $data = Variation::join('products' ,'products.id','variations.product_id')
                    ->join('weights' ,'weights.id','variations.weight_id')
       ...
       // dd($data);
        ...
        if ($variation) { 
            $html='<tr><td><img src="/products/'.$variation->product->image.'" height="50" width="50"/></td>
                    ...
                    <td><input class="form-control unit_price" name="unit_price[]" type="number" value="'.$variation->price.'" required/></td>
