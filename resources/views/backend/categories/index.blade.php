                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="col-auto">
                                <a class=" btn btn-sm btn-info popular_update" href="{{ route('admin.popularCatgeory')}}?is_popular=1">এক্টিভ জনপ্রিয় ক্যাটাগরি</a>
                                <a class=" btn btn-sm btn-danger popular_update" href="{{ route('admin.popularCatgeory')}}?is_popular=0">ডি-এক্টিভ জনপ্রিয় ক্যাটাগরি</a>
                            </div>
                        </div>
