...
<div class="axil-product product-style-one" style="padding: 0px !important;">
    <div class="thumbnail" style="padding: 4px !important">
        ...
        <div class="label-block label-right">
            <div class="product-badget" style="background: #fc8934;">{{$product->discount_type=='fixed'?'':''}}{{$product->discount}} {{$product->discount_type=='fixed'?'':'%'}} Off</div>
        </div>
        @endif
    ...
    <div class="product-content">
        <div class="inner">
            <h5 class="title text-center"><a href="{{ route('front.products.show',[$product->id])}}">{{ \Illuminate\Support\Str::limit($product->name, 20) }}</a></h5>
            <div class="product-price-variant text-center py-2">
                <span class="price current-price" style="color: #000">
                  @php  
                    $curr = $info->currency;                   
                  @endphp
    ...
    @if($product->type=="single")
            <form method="POST" action="{{ route('front.carts.store')}}" id="cart_form">
                ...
                <div class="desktop-cart cart-count" style="padding-bottom: 0px;">
                    <div class="product-add-to-cart col-12">
                        <div class="cart-action col-12">
                            <div class="select-option col-12" style="margin-bottom: 5px;">
                                <button type="submit" class="btn p-0 button m-auto text-light col-12" style="background: #ED5565 !important;"> 
                                    <b style="font-size: 15px;font-family: 'Hind Siliguri', sans-serif;color: #fff;">
            ...
            @else
                ...
                <div class="desktop-cart cart-count" style="padding-bottom: 0px;">
                    <div class="product-add-to-cart col-12">
                        <div class="cart-action col-12">
                            <div class="select-option col-12" style="margin-bottom: 0px;">
                                <button type="submit" class="btn p-0 button m-auto text-light col-12" style="background: #ED5565 !important;"> 
                                   <b style="font-size: 15px;font-family: 'Hind Siliguri', sans-serif;color: #fff;">
                                          <i class="fas fa-shopping-cart" style="color: #fff;"></i>
                                         &nbsp; {{ $bangla_text->order_text }}</b>
